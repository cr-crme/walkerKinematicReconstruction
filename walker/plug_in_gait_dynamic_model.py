...
class PlugInGaitDynamicModel:
    ...
    def segment_mass(self, segment: biorbd.Segment):
        return self.table[self.sex][segment].mass * self.mass

    def segment_length(self, segment: biorbd.Segment):
    ...
    def segment_center_of_mass(self, segment: biorbd.Segment, inverse_proximal: bool = False):
    ...
    def segment_moment_of_inertia(self, segment: biorbd.Segment):
